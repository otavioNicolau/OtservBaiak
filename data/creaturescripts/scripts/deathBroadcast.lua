local config = {
	affected = 100, -- how many players (deathAssits) from table deathList should this script be executed for?
	...
	broadcastMessage = {
		...
		minLevel = false, -- false if you don't want any level req
		minLevelDiff = false, -- false if you don't want any level diff req (negative numbers allowed).
		text = "|KILLERNAME| [|KILLERLEVEL|] acaba de Assassinar |TARGETNAME| [|TARGETLEVEL|]!",
		messageClass = MESSAGE_STATUS_CONSOLE_RED
	},

	killerAnimation = {
		use = true,
		text = "Killer!", -- Only 9 letters! No "commands" here.
		color = 144
	},
